 ...
 public class InterfaceFieldSet
 {
   ...
   public void getField(String pPosition) {
     ...
     int lenght = 0;
     String str1;
     switch ((str1 = format).hashCode()) { case 66: if (!str1.equals("B")) {
           break;
         }
         ...
         generateResponseBitamp(pPosition, lenght); return;
       case 70:
         if (!str1.equals("F"))
           break;  lenght = Integer.parseInt(((Fields)this.interfaceFieldSet.get(pPosition)).getLenght()); generateResponseFixed(lenght, name, type); return; }  generateResponseLVars(format.length(), name);
   }
